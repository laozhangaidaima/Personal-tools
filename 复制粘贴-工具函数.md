...
```
getDeviceRight: async function () {
let url = baseUrl + '/CustBusiness/GetCustDeviceByType';
let dataP = {
CustId: this.custId
};
let res = await axios.post(url, dataP);
if(res.data.code==100){
this.deviceChart.chartData2.rows = Enumerable.from(res.data.content.datas).select(
x => {
return {
'型号': x.TypeName,
'数量': x.Count

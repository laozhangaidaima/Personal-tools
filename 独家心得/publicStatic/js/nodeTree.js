Vue.component('node-tree', {
    ...
    methods: {
        ...
        onClickNode: function (node) {
            if (this.valueModel !== node[this.props.value]) {
                this.$emit('nodechange', node[this.props.value]);
            }
    ...
    template: '<el-popover ref="popover" placement="bottom-start" trigger="click" @show="onShowPopover" @hide="onHidePopover" >' +
        '<el-tree ref="tree" class="select-tree" highlight-current :style="{\'min-width\':treeWidth}" :data="data" :props="props" :expand-on-click-node="false" :filter-node-method="filterNode"' +
